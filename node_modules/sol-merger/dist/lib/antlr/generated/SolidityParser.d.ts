...
export declare class SolidityParser extends Parser {
    ...
    static readonly Int = 93;
    static readonly Uint = 94;
    static readonly Byte = 95;
    static readonly Fixed = 96;
    static readonly Ufixed = 97;
    static readonly BooleanLiteral = 98;
    static readonly DecimalNumber = 99;
    static readonly HexNumber = 100;
    static readonly NumberUnit = 101;
    static readonly HexLiteralFragment = 102;
    static readonly ReservedKeyword = 103;
    static readonly AnonymousKeyword = 104;
    static readonly BreakKeyword = 105;
    static readonly ConstantKeyword = 106;
    static readonly ImmutableKeyword = 107;
    static readonly ContinueKeyword = 108;
    static readonly LeaveKeyword = 109;
    static readonly ExternalKeyword = 110;
    static readonly IndexedKeyword = 111;
    static readonly InternalKeyword = 112;
    static readonly PayableKeyword = 113;
    static readonly PrivateKeyword = 114;
    static readonly PublicKeyword = 115;
    static readonly VirtualKeyword = 116;
    static readonly PureKeyword = 117;
    static readonly TypeKeyword = 118;
    static readonly ViewKeyword = 119;
    static readonly ConstructorKeyword = 120;
    static readonly FallbackKeyword = 121;
    static readonly ReceiveKeyword = 122;
    static readonly Identifier = 123;
    static readonly StringLiteralFragment = 124;
    static readonly VersionLiteral = 125;
    static readonly WS = 126;
    static readonly COMMENT = 127;
    static readonly LINE_COMMENT = 128;
    ...
    static readonly RULE_versionConstraint = 5;
    static readonly RULE_versionOperator = 6;
    static readonly RULE_importDirective = 7;
    static readonly RULE_importDeclaration = 8;
    ...
    static readonly RULE_overrideSpecifier = 13;
    ...
    static readonly RULE_functionDefinition = 17;
    static readonly RULE_functionDescriptor = 18;
    static readonly RULE_returnParameters = 19;
    static readonly RULE_modifierList = 20;
    static readonly RULE_modifierInvocation = 21;
    static readonly RULE_eventDefinition = 22;
    static readonly RULE_enumDefinition = 23;
    static readonly RULE_enumValue = 24;
    ...
    static readonly RULE_variableDeclaration = 29;
    static readonly RULE_typeName = 30;
    static readonly RULE_userDefinedTypeName = 31;
    static readonly RULE_mapping = 32;
    static readonly RULE_functionTypeName = 33;
    static readonly RULE_storageLocation = 34;
    static readonly RULE_stateMutability = 35;
    static readonly RULE_block = 36;
    static readonly RULE_statement = 37;
    static readonly RULE_expressionStatement = 38;
    static readonly RULE_ifStatement = 39;
    static readonly RULE_tryStatement = 40;
    static readonly RULE_catchClause = 41;
    static readonly RULE_whileStatement = 42;
    static readonly RULE_forStatement = 43;
    static readonly RULE_simpleStatement = 44;
    static readonly RULE_inlineAssemblyStatement = 45;
    static readonly RULE_doWhileStatement = 46;
    static readonly RULE_continueStatement = 47;
    static readonly RULE_breakStatement = 48;
    static readonly RULE_returnStatement = 49;
    static readonly RULE_throwStatement = 50;
    static readonly RULE_emitStatement = 51;
    static readonly RULE_variableDeclarationStatement = 52;
    static readonly RULE_variableDeclarationList = 53;
    static readonly RULE_identifierList = 54;
    static readonly RULE_elementaryTypeName = 55;
    static readonly RULE_expression = 56;
    static readonly RULE_primaryExpression = 57;
    static readonly RULE_expressionList = 58;
    static readonly RULE_nameValueList = 59;
    static readonly RULE_nameValue = 60;
    static readonly RULE_functionCallArguments = 61;
    static readonly RULE_functionCall = 62;
    static readonly RULE_tupleExpression = 63;
    static readonly RULE_typeNameExpression = 64;
    static readonly RULE_assemblyItem = 65;
    static readonly RULE_assemblyBlock = 66;
    static readonly RULE_assemblyExpression = 67;
    static readonly RULE_assemblyCall = 68;
    static readonly RULE_assemblyLocalDefinition = 69;
    static readonly RULE_assemblyAssignment = 70;
    static readonly RULE_assemblyIdentifierList = 71;
    static readonly RULE_assemblyStackAssignment = 72;
    static readonly RULE_labelDefinition = 73;
    static readonly RULE_assemblySwitch = 74;
    static readonly RULE_assemblyCase = 75;
    static readonly RULE_assemblyFunctionDefinition = 76;
    static readonly RULE_assemblyFunctionReturns = 77;
    static readonly RULE_assemblyFor = 78;
    static readonly RULE_assemblyIf = 79;
    static readonly RULE_assemblyLiteral = 80;
    static readonly RULE_assemblyTypedVariableList = 81;
    static readonly RULE_assemblyType = 82;
    static readonly RULE_subAssembly = 83;
    static readonly RULE_numberLiteral = 84;
    static readonly RULE_identifier = 85;
    static readonly RULE_hexLiteral = 86;
    static readonly RULE_stringLiteral = 87;
    ...
    assemblyTypedVariableList(): AssemblyTypedVariableListContext;
    assemblyType(): AssemblyTypeContext;
...
export declare class AssemblyCaseContext extends ParserRuleContext {
    assemblyLiteral(): AssemblyLiteralContext | undefined;
    assemblyBlock(): AssemblyBlockContext;
    assemblyType(): AssemblyTypeContext | undefined;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
    enterRule(listener: SolidityListener): void;
    exitRule(listener: SolidityListener): void;
...
export declare class AssemblyFunctionDefinitionContext extends ParserRuleContext {
    identifier(): IdentifierContext;
    assemblyBlock(): AssemblyBlockContext;
    assemblyTypedVariableList(): AssemblyTypedVariableListContext | undefined;
...
export declare class AssemblyTypedVariableListContext extends ParserRuleContext {
    identifier(): IdentifierContext;
    assemblyType(): AssemblyTypeContext | undefined;
    assemblyTypedVariableList(): AssemblyTypedVariableListContext | undefined;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
...
export declare class AssemblyTypeContext extends ParserRuleContext {
    identifier(): IdentifierContext;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
    enterRule(listener: SolidityListener): void;
