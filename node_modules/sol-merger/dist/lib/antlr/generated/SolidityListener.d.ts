...
import { AssemblyTypedVariableListContext } from "./SolidityParser";
import { AssemblyTypeContext } from "./SolidityParser";
...
export interface SolidityListener extends ParseTreeListener {
     ...
     * @param ctx the parse tree
     */
    enterAssemblyTypedVariableList?: (ctx: AssemblyTypedVariableListContext) => void;
    /**
     * Exit a parse tree produced by `SolidityParser.assemblyTypedVariableList`.
     * @param ctx the parse tree
     */
    exitAssemblyTypedVariableList?: (ctx: AssemblyTypedVariableListContext) => void;
    /**
     * Enter a parse tree produced by `SolidityParser.assemblyType`.
     * @param ctx the parse tree
     */
    enterAssemblyType?: (ctx: AssemblyTypeContext) => void;
    /**
     * Exit a parse tree produced by `SolidityParser.assemblyType`.
     * @param ctx the parse tree
     */
    exitAssemblyType?: (ctx: AssemblyTypeContext) => void;
    /**
