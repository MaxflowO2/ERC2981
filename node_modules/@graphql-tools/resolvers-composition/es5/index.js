...
function chainFunctions(funcs) {
    ...
    return funcs.reduce(function (a, b) { return function () {
        ...
        return a(b.apply(void 0, tslib.__spreadArray([], tslib.__read(args), false)));
    }; });
}
...
function composeResolvers(resolvers, mapping) {
    ...
    var _loop_1 = function (path) {
        var fns = chainFunctions(tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(utils.asArray(mappingResult[path])), false), [function () { return _.get(resolvers, path); }], false));
