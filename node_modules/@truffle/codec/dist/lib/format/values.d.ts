...
import { ElementaryValue, UintValue, IntValue, BoolValue, BytesStaticValue, BytesDynamicValue, AddressValue, StringValue, FixedValue, UfixedValue, EnumValue, ContractValue, ContractValueInfoKnown, ContractValueInfoUnknown } from "./elementary";
 ...
 * @Category General categories
 */
export declare type ElementaryResult = UintResult | IntResult | BoolResult | BytesResult | AddressResult | StringResult | FixedResult | UfixedResult | EnumResult | ContractResult;
/**
