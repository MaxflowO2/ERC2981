...
import { PaddingType } from "../common";
/**
 * A result which is an error rather than a value
 *
 * @Category General categories
 */
export declare type ErrorResult = ElementaryErrorResult | ArrayErrorResult | MappingErrorResult | StructErrorResult | MagicErrorResult | TypeErrorResult | TupleErrorResult | FunctionExternalErrorResult | FunctionInternalErrorResult;
/**
 * One of the underlying errors contained in an [[ErrorResult]]
 *
 * @Category General categories
 */
export declare type DecoderError = GenericError | UintError | IntError | BoolError | BytesStaticError | BytesDynamicError | AddressError | StringError | FixedError | UfixedError | ArrayError | MappingError | StructError | MagicError | TypeErrorUnion | TupleError | EnumError | ContractError | FunctionExternalError | FunctionInternalError | InternalUseError;
/**
 * An error result for an elementary value
 *
 * @Category Elementary types
 */
export declare type ElementaryErrorResult = UintErrorResult | IntErrorResult | BoolErrorResult | BytesErrorResult | AddressErrorResult | StringErrorResult | FixedErrorResult | UfixedErrorResult | EnumErrorResult | ContractErrorResult;
/**
