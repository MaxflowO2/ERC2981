...
SOL_ASSEMBLY_KEYWORDS:n,baseAssembly:a=>{
var o=t(a),c=l(a),d=/[A-Za-z_$][A-Za-z_$0-9.]*/,_=/\bverbatim_[1-9]?[0-9]i_[1-9]?[0-9]o\b(?!\$)/
;e()&&(_=_.source.replace(/\\b/,"(?<!\\$)\\b"));var u={className:"built_in",
begin:_},m=a.inherit(a.TITLE_MODE,{begin:/[A-Za-z$_][0-9A-Za-z$_]*/,lexemes:d,
keywords:n}),b={className:"params",begin:/\(/,end:/\)/,excludeBegin:!0,
excludeEnd:!0,lexemes:d,keywords:n,
contains:[a.C_LINE_COMMENT_MODE,a.C_BLOCK_COMMENT_MODE,o,c,s]},E={
className:"operator",begin:/:=|->/};return{keywords:n,lexemes:d,
contains:[o,c,i,r,a.C_LINE_COMMENT_MODE,a.C_BLOCK_COMMENT_MODE,u,s,E,{
className:"function",lexemes:d,beginKeywords:"function",end:"{",excludeEnd:!0,
contains:[m,b,a.C_LINE_COMMENT_MODE,a.C_BLOCK_COMMENT_MODE,E]}]}},
...
;const{baseAssembly:c,solAposStringMode:d,solQuoteStringMode:_,HEX_APOS_STRING_MODE:u,HEX_QUOTE_STRING_MODE:m,SOL_NUMBER:b,isNegativeLookbehindAvailable:E}=o
;return e=>{for(var a=d(e),s=_(e),n=[],i=0;i<32;i++)n[i]=i+1
...
excludeEnd:!0,keywords:{built_in:"slot offset length"},relevance:2},{begin:/_/,
end:/[^A-Za-z0-9$.]/,excludeBegin:!0,excludeEnd:!0,keywords:{
built_in:"slot offset"},relevance:2}])});return{aliases:["sol"],keywords:p,
lexemes:C,contains:[a,s,u,m,e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE,b,w,O,{
...
contains:[y,a,s,u,m,e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE,O]},{
