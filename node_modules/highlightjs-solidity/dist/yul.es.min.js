...
literal:"true false"},l={className:"string",
begin:/\bhex'(([0-9a-fA-F]{2}_?)*[0-9a-fA-F]{2})?'/},r={className:"string",
begin:/\bhex"(([0-9a-fA-F]{2}_?)*[0-9a-fA-F]{2})?"/};function d(e){
return e.inherit(e.APOS_STRING_MODE,{begin:/(\bunicode)?'/})}function i(e){
return e.inherit(e.QUOTE_STRING_MODE,{begin:/(\bunicode)?"/})}var o={
SOL_ASSEMBLY_KEYWORDS:t,baseAssembly:a=>{
var o=d(a),n=i(a),c=/[A-Za-z_$][A-Za-z_$0-9.]*/,u=/\bverbatim_[1-9]?[0-9]i_[1-9]?[0-9]o\b(?!\$)/
;e()&&(u=u.source.replace(/\\b/,"(?<!\\$)\\b"));var p={className:"built_in",
begin:u},_=a.inherit(a.TITLE_MODE,{begin:/[A-Za-z$_][0-9A-Za-z$_]*/,lexemes:c,
keywords:t}),b={className:"params",begin:/\(/,end:/\)/,excludeBegin:!0,
excludeEnd:!0,lexemes:c,keywords:t,
contains:[a.C_LINE_COMMENT_MODE,a.C_BLOCK_COMMENT_MODE,o,n,s]},m={
className:"operator",begin:/:=|->/};return{keywords:t,lexemes:c,
contains:[o,n,l,r,a.C_LINE_COMMENT_MODE,a.C_BLOCK_COMMENT_MODE,p,s,m,{
className:"function",lexemes:c,beginKeywords:"function",end:"{",excludeEnd:!0,
contains:[_,b,a.C_LINE_COMMENT_MODE,a.C_BLOCK_COMMENT_MODE,m]}]}},
solAposStringMode:d,solQuoteStringMode:i,HEX_APOS_STRING_MODE:l,
HEX_QUOTE_STRING_MODE:r,SOL_NUMBER:s,isNegativeLookbehindAvailable:e}
;const{SOL_ASSEMBLY_KEYWORDS:n,baseAssembly:c}=o;return e=>{var a={
...
literal:n.literal};return e.inherit(c(e),{keywords:a})}})()
